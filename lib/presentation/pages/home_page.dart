...
import 'package:home_monitor/di/app_upgrade_repo_scope.dart';
...
import 'package:home_monitor/di/platform_upgrade_scope.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  @override
  Widget build(final BuildContext context) => AppUpgradeRepoScope(
    child: PlatformUpgradeScope(
      child: AppUpgradeComponent(
